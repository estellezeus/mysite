    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item menu-open user-panel mt-3 pb-3 mb-3">
                    <div class="image">
                        <img src="{{asset('backend/assets/dist/img/user2-160x160.jpg')}}" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        ...
                        <p>
                            ...
                            <span class="badge badge-info right">{{ \Session::get('nbPubBooks')}}</span>
                        </p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link">
                        ...
                        <p>
                            Catégories
                            <i class="fas fa-angle-left right"></i>
                            <span class="badge badge-info right">{{ \Session::get('nbCateg')}}</span>
                        </p>
                    </a>
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
