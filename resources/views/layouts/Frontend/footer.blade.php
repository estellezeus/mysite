            ...
            <div class="col-lg-4 col-md-6 footer-about">
                <div class="d-flex flex-column align-items-center justify-content-center text-center h-100 bg-primary p-4">
                    <a href="{{route('welcome')}}" class="navbar-brand">
                        <h1 class="m-0 text-white">Estelle Z</h1>
                    </a>
                ...
                <div class="row gx-5">
                    <div class="col-lg-4 col-md-12 pt-5 mb-5">
                        <div class="section-title section-title-sm position-relative pb-3 mb-4">
                            <h3 class="text-light mb-0">Contactez-moi</h3>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                        ...
                        <div class="link-animated d-flex flex-column justify-content-start">
                            <a class="text-light mb-2" href="{{route('welcome')}}"><i class="bi bi-arrow-right me-2"></i>Accueil</a>
                            <a class="text-light mb-2" href="{{route('books')}}"><i class="bi bi-arrow-right me-2"></i>Livres</a>
        ...
        <div class="row justify-content-end">
            <div class="col-lg-8 col-md-6">
                <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                    <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">EstelleZ</a>. Tous droits réservés.
