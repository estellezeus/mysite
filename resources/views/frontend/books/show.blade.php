        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded mb-5" src="{{ asset("storage/app/books/".$book->image) }}" alt="">
                   ...
                   {{-- <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                    ...
                    <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <div class="d-flex rounded overflow-hidden mb-3">
                            <img class="img-fluid" src="{{ asset("public/storage/app/books/".$b->image) }}" style="width: auto; height: 100px; object-fit: cover;" alt="">
